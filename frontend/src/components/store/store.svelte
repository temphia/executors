<script>
  ...
  export let onChangeSource = (nextsrc) => {};
...
>
  ...
  <div class="flex flex-wrap justify-center gap-2 p-2">
    {#each items as item, i}
      <div
        class="p-4 2xl:w-1/6 xl:w-1/5 lg:1/4 md:w-1/3 w-full bg-white p-4 rounded-md hover:border-purple-600 border cursor-pointer relative"
