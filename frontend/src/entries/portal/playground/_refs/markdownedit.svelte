  ...
  <div class="px-4 max-w-4xl mx-auto min-h-screen py-12">
    ...
    <div class="relative">
      ...
      >
        <button
          type="button"
          class="py-2 px-4 inline-block text-gray-400 font-semibold text-indigo-600"
          >Write</button
        >
        <button
          type="button"
      ...
      <div x-show="! showConvertedMarkdown">
        <div>
          <textarea id="xx" class="hidden" name="content" />
        </div>
      </div>
    ...
    <div class="mt-6 text-gray-500 text-sm text-center">
      Created by <a
        ...
        href="https://twitter.com/mithicher">@mithicher</a
      >.
    </div>
  </div>
</div>
