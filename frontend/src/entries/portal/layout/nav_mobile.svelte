                ...
                <ul class="space-y-4 pt-10">
                    {#each route_links as link}
                        <li class="border rounded">
                            <Link
                                to={link[2] + ""}
                                getProps={() => ({
                                    class: "h-12 px-4 flex flex justify-center items-center w-full text-gray-700 focus:text-orange-500 uppercase",
                                })}
                            >
                    ...
                    <li class="border rounded">
                        <button
                            ...
                            class="h-12 cursor-pointer mx-auto flex flex justify-center items-center
