<script lang="ts">
  ...
  import type { DataTableService, Navigator } from "../../../../../services";
...
<View columns={Object.values(_columns_indexed)} {manager} bind:show={_show_view} />
