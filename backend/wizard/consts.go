...
const (
	...
	IMAGE_SELECT       = "adv.imgselect"
	IMAGE_MULTI_SELECT = "adv.multi_imgselect"
	JSON_OBJECT        = "adv.json_object"
	JSON_INLINE_OBJECT = "adv.json_inline_object"
	LOCATION           = "adv.location"

	VIEW_STATICHTML    = "view.statichtml"
	VIEW_DYNAMICHTML   = "view.dynhtml"
	VIEW_PARAGRAPH     = "view.paragraph"
	VIEW_IMAGE         = "view.img"
	VIEW_FILE          = "view.file"
	VIEW_IMAGE_ALBUM   = "view.imgalbum"
	VIEW_CHARTJS_GRAPH = "view.chartgraph"
